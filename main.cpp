...
F2_polynom addition(const F2_polynom &i_polynom_left,const F2_polynom &i_polynom_right){
    /*
...
F2_polynom substraction(const F2_polynom &i_polynom_left,const F2_polynom &i_polynom_right){
    /*
...
F2_polynom multiplication(const F2_polynom &i_polynom_left,const F2_polynom &i_polynom_right){
    /*
...
std::vector<F2_polynom> division(const F2_polynom &i_dividende_polynom, const F2_polynom &i_diviseur_polynom){
    /*
...
F2_polynom compute_derivation(const F2_polynom &i_polynom){
    /*
...
F2_polynom compute_square_root(const F2_polynom &i_polynom){
    /*
